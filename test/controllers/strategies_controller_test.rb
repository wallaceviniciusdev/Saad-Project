...
class StrategiesControllerTest < ActionController::TestCase
  ...
  test "should create strategy" do
    assert_difference('Strategy.count') do
      post :create, strategy: { deadline: @strategy.deadline, objective_id: @strategy.objective_id, text: @strategy.text }
    end
  ...
  test "should update strategy" do
    patch :update, id: @strategy, strategy: { deadline: @strategy.deadline, objective_id: @strategy.objective_id, text: @strategy.text }
    assert_redirected_to strategy_path(assigns(:strategy))
  end

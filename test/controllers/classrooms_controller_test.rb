...
class ClassroomsControllerTest < ActionController::TestCase
  ...
  test "should create classroom" do
    assert_difference('Classroom.count') do
      post :create, classroom: { codigo: @classroom.codigo, subject_id: @classroom.subject_id, turno: @classroom.turno }
    end
  ...
  test "should update classroom" do
    patch :update, id: @classroom, classroom: { codigo: @classroom.codigo, subject_id: @classroom.subject_id, turno: @classroom.turno }
    assert_redirected_to classroom_path(assigns(:classroom))
  end

...
class RespostaControllerTest < ActionController::TestCase
  ...
  test "should create respostum" do
    assert_difference('Respostum.count') do
      post :create, respostum: { atividade_extra_id: @respostum.atividade_extra_id, observacao: @respostum.observacao }
    end
  ...
  test "should update respostum" do
    patch :update, id: @respostum, respostum: { atividade_extra_id: @respostum.atividade_extra_id, observacao: @respostum.observacao }
    assert_redirected_to respostum_path(assigns(:respostum))
  end
